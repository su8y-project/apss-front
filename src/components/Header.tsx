...
export function Header({className}: HeaderProps) {
    ...
    return (
        <header
            className={cn("flex items-center justify-between border-b border-white/5 bg-slate-950/50 px-6 py-3 backdrop-blur-md", className)}>
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h1 className="text-sm font-bold tracking-wide text-indigo-100">AI QUANT <span
                            className="text-indigo-500">COCKPIT</span></h1>
                ...
                <div className="hidden h-6 items-center gap-2 border-l border-white/5 pl-4 sm:flex">
                    <div
                        className="flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-2.5 py-0.5 text-[10px] font-medium text-emerald-400 ring-1 ring-emerald-500/20">
            ...
            <div className="flex items-center gap-6">
                <div className="relative" ref={dropdownRef}>
                    ...
                    {isShareOpen && (
                        <div
                            className="absolute right-0 top-full mt-2 w-48 origin-top-right rounded-xl border border-white/10 bg-slate-900/90 p-1 shadow-xl backdrop-blur-xl ring-1 ring-black/50 z-50">
                            <button
                ...
                <div className="border-l border-white/5 pl-6">
                    {isLoggedIn ? (
                        ...
                        >
                            <div
                                className="flex h-5 w-5 items-center justify-center rounded-full bg-white text-black p-0.5">
